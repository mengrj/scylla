...
(defn install-scylla-from-deb!
  ...
  (c/su
    ...
    (c/exec :dpkg :-i :"/jepsen/scylla/packages/scylla-python3_4.7.dev-0.20220101.3ac622bdd-1_amd64.deb")
    (c/exec :dpkg :-i :"/jepsen/scylla/packages/scylla-conf_4.7.dev-0.20220101.3ac622bdd-1_amd64.deb")
    (c/exec :dpkg :-i :"/jepsen/scylla/packages/scylla-server_4.7.dev-0.20220101.3ac622bdd-1_amd64.deb")
    (c/exec :dpkg :-i :"/jepsen/scylla/packages/scylla-jmx_4.7.dev-0.20220101.3ac622bdd-1_all.deb")
    (c/exec :dpkg :-i :"/jepsen/scylla/packages/scylla-kernel-conf_4.7.dev-0.20220101.3ac622bdd-1_amd64.deb")
    (c/exec :dpkg :-i :"/jepsen/scylla/packages/scylla-tools-core_4.7.dev-0.20220101.3ac622bdd-1_all.deb")
    (c/exec :dpkg :-i :"/jepsen/scylla/packages/scylla-tools_4.7.dev-0.20220101.3ac622bdd-1_all.deb")
    (c/exec :dpkg :-i :"/jepsen/scylla/packages/scylla-node-exporter_4.7.dev-0.20220101.3ac622bdd-1_amd64.deb")
    (c/exec :dpkg :-i :"/jepsen/scylla/packages/scylla_4.7.dev-0.20220101.3ac622bdd-1_amd64.deb")
  ))
